...
namespace TransactionService.Controllers
{
    ...
    public class PaymentsController : ApiController
    {
        ...
        public IQueryable<MethodOfPaymentModel> Get()
        {
            return dbContext.MethodOfPaymentModels;
        }
        ...
        public async Task<IHttpActionResult> Post(
            [FromBody] PosTransactionModel posTransaction
        )
        {
            ...
            if (paymentOk)
            {
                ...
                dbContext.PosTransactionModels.Add(posTransaction);
                ...
                try
                {
                    ...
                    await client.Post<PosTransactionModel>("api/Transactions", posTransaction);
                }
                catch(Exception ex)
                {
