...
namespace AuthService.Controllers
{
    ...
    public class UserInfoController : ApiController
    {
        ...
        //[System.Web.Http.Authorize]
        public SafeServiceUserInfo Get()
        {
            var principal = Request.GetRequestContext().Principal as ClaimsPrincipal;
            var userId = principal.Identity.GetUserId();
            //var userManager = new ServiceUserManager(new UserStore<ServiceUser>(dbContext));//context.OwinContext.GetUserManager<ServiceUserManager>();
            //var serviceUser = userManager.Users.Include(u => u.Claims).First(us => us.Id == userId);
            var _ = new SafeServiceUserInfo()
            {
