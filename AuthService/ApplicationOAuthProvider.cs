...
namespace AuthService
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            claims.Add(new Claim("string0", "value0"));
            //claims.Add(new Claim("string1", "value1"));
            //claims.Add(new Claim("string2", "value2"));
            //claims.Add(new Claim("string3", "value3"));
            //claims.Add(new Claim("string4", "value4"));
            foreach (var c in claims)
            {
                userManager.AddClaim(user.Id, c);
            }
